  ...
  var TreeBuilder = (function () {
    ...
    _createClass(TreeBuilder, [{
      ...
      value: function create() {
        ...
        console.log("this.nodeSize _createClass = "+ this.nodeSize)
      ...
      value: function _update(source) {
        ...
        var allNodes = this.allNodes;
        var nodeSize = this.nodeSize;
        console.log("this.nodeSize _update = "+ this.nodeSize)
      ...
      value: function _siblingLine(d, i) {
        ...
        console.log("nodeWidth _siblingLine = "+ nodeWidth)
        console.log("nodeHeight _siblingLine = "+ nodeHeight)
